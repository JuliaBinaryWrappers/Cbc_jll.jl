# Autogenerated wrapper script for Cbc_jll for x86_64-apple-darwin14-libgfortran5-cxx03
...
const libcbcsolver = "@rpath/libCbcSolver.3.dylib"
...
# This must be `const` so that we can use it with `ccall()`
const libCbc = "@rpath/libCbc.3.dylib"
