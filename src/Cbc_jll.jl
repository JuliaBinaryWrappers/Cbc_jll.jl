...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Cbc_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("38041ee0-ae04-5750-a4d2-bb4d0d83d27d"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Cbc", artifacts_toml) for e in artifacts["Cbc"]]
...
if best_platform === nothing
    @debug("Unable to load Cbc; unsupported platform $(triplet(platform_key_abi()))")
else
